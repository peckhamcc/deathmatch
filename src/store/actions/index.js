...
export const BLUETOOTH_SEARCH_ERROR = 'BLUETOOTH_SEARCH_ERROR'
...
export const FREEPLAY_SET = 'FREEPLAY/SET'
export const NUM_PLAYERS_SET = 'NUM_PLAYERS/SET'
...
export const bluetoothSearchError = setAction(BLUETOOTH_SEARCH_ERROR)
...
export const setLeaderboard = setAction(LEADERBOARD_SET)
export const setFreeplay = setAction(FREEPLAY_SET)
export const setNumPlayers = setAction(NUM_PLAYERS_SET)
